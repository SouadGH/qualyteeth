...
export class DentistService {
     ...
     *
     */
    async findTimetableForDentist(dentistId: number): Promise<Array<DentistTimetable>> {
        try {
     ...
     *
     */
    async updateTimetable(dentistId: number, timetables: Array<DentistTimetable>): Promise<void> {
