...
// import { PractitionerService } from 'apps/qualyteeth-server/src/core/practitioner/practitioner.service';
...
//      * 
//      */
//     constructor(private dbService: DbService, private practitionerSvc: PractitionerService) { }
...
//             const timetable: Array<any> = await this.practitionerSvc.findTimetableForDentist(dentistId);
//             for (let i = 1; i <= 7; i++) {
