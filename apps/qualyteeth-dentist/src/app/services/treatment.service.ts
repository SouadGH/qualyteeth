...
export class TreatmentService {
   ...
   *
   */
  public async getActsForDefinition(id: number): Promise<Array<Act>> {
    const accessToken = await this.storageSvc.get('accessTokenQD');
    ...
    return await this.httpClient.get<Array<Act>>(`${API_ENDPOINT}/treatment/definition/acts/${id}`, { headers: headers }).toPromise();
  }
   ...
   *
   */
  public async getActs(): Promise<Array<Act>> {
    const accessToken = await this.storageSvc.get('accessTokenQD');
    ...
    return await this.httpClient.get<Array<Act>>(`${API_ENDPOINT}/treatment/acts/`, { headers: headers }).toPromise();
  }
